...
<<<<<<< HEAD
      ...
      avgcol_nrACperCell[i][j] = 0.0;
      avgcol_nrADperCell[i][j] = 0.0;
      avgcol_nrAEperCell[i][j] = 0.0;
      avgcol_nrAFperCell[i][j] = 0.0;
     
      avgcol_nrBCperCell[i][j] = 0.0;
      avgcol_nrBDperCell[i][j] = 0.0;
      avgcol_nrBEperCell[i][j] = 0.0;
      avgcol_nrBFperCell[i][j] = 0.0;
     
      avgcol_nrCDperCell[i][j] = 0.0;
      avgcol_nrCEperCell[i][j] = 0.0;
      avgcol_nrCFperCell[i][j] = 0.0;
      
      avgcol_nrDEperCell[i][j] = 0.0;
      avgcol_nrDFperCell[i][j] = 0.0;
      
      avgcol_nrEFperCell[i][j] = 0.0;

      avgcol_nrnonA_AperCell[i][j]=0.0;  
      avgcol_nrnonB_BperCell[i][j]=0.0;
      avgcol_nrnonC_CperCell[i][j]=0.0;
      avgcol_nrnonD_DperCell[i][j]=0.0;
      avgcol_nrnonD_EperCell[i][j]=0.0;
...
<<<<<<< HEAD
    ...
    int nrE=protocells[usednrs[i]]->GetNumberOfMoleculesOfType(4); //new
    int nrF=protocells[usednrs[i]]->GetNumberOfMoleculesOfType(5); //new
    ...
    int adjusted_nonA=nrnonA;
    int adjusted_nonB=nrnonB;
    int adjusted_nonC=nrnonC;
    int adjusted_nonD=nrnonD;
    int adjusted_nonE=nrnonE;
    int adjusted_nonF=nrnonF;
...
//    int adjusted_B=m-nrnonB;
    ...
    if (adjusted_nonA > 100){
        adjusted_nonA = 100;
      }
    if (adjusted_nonB > 100){
        adjusted_nonB = 100;
      } 
    if (adjusted_nonC > 100){
        adjusted_nonC = 100;
      } 
    if (adjusted_nonD > 100){
        adjusted_nonD = 100;
      } 

    if (adjusted_nonE > 100){
        adjusted_nonE = 100;
      } 
   
    if (adjusted_nonF > 100){
        adjusted_nonF = 100;
    } 
    ...
    avgcol_nrABperCell[adjusted_A][adjusted_B]+=1;
    avgcol_nrACperCell[adjusted_A][adjusted_C]+=1;
    avgcol_nrADperCell[adjusted_A][adjusted_D]+=1;
    avgcol_nrAEperCell[adjusted_A][adjusted_E]+=1;
    avgcol_nrAFperCell[adjusted_A][adjusted_F]+=1;
    
    avgcol_nrBCperCell[adjusted_B][adjusted_C]+=1;
    avgcol_nrBDperCell[adjusted_B][adjusted_D]+=1;
    avgcol_nrBEperCell[adjusted_B][adjusted_E]+=1;
    avgcol_nrBFperCell[adjusted_B][adjusted_F]+=1;
    

    avgcol_nrCDperCell[adjusted_C][adjusted_D]+=1;
    avgcol_nrCEperCell[adjusted_C][adjusted_E]+=1;
    avgcol_nrCFperCell[adjusted_C][adjusted_F]+=1;

   


    avgcol_nrDEperCell[adjusted_D][adjusted_E]+=1;
    avgcol_nrDFperCell[adjusted_D][adjusted_F]+=1;
    avgcol_nrEFperCell[adjusted_E][adjusted_F]+=1;



    avgcol_nrnonA_AperCell[adjusted_nonA][adjusted_A]+=1;  
    avgcol_nrnonB_BperCell[adjusted_nonB][adjusted_B]+=1;
    avgcol_nrnonC_CperCell[adjusted_nonC][adjusted_C]+=1;
    avgcol_nrnonD_DperCell[adjusted_nonD][adjusted_D]+=1;
    avgcol_nrnonD_EperCell[adjusted_nonE][adjusted_E]+=1;
...
<<<<<<< HEAD
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrACperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrADperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrAEperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrAFperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrBCperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrBDperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrBEperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrBFperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrCDperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrCEperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
  ...
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrCFperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
...
of << "#nrDE" << endl;
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrDEperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
...
of << "#nrDF" << endl;
  for (int i=0; i<101; i++) {
    for (int j=0; j<101; j++){
      of <<  avgcol_nrDFperCell[i][j]*tval <<"\t";
    } 
    of << endl;
  }
